...
void main() {
  ...
  group('File', () {
    ...
    test(
      'should emit with line comments, generated-by, and ignore-for-file',
      () {
        expect(
          Library(
            (b) => b
    ...
    test('should emit a source file with a deferred import', () {
      expect(
        Library(
          (b) => b
            ..directives.add(
              Directive.importDeferredAs('package:foo/foo.dart', 'foo'),
            ),
        ),
        equalsDart(r'''
    ...
    test('should emit a source file with a "show" combinator', () {
      expect(
        Library(
          (b) => b
            ..directives.add(
              Directive.import('package:foo/foo.dart', show: ['Foo', 'Bar']),
            ),
        ),
        equalsDart(r'''
    ...
    test('should emit a source file with a "hide" combinator', () {
      expect(
        Library(
          (b) => b
            ..directives.add(
              Directive.import('package:foo/foo.dart', hide: ['Foo', 'Bar']),
            ),
        ),
        equalsDart(r'''
    ...
    test('should emit a source file with part directives', () {
      expect(
        Library((b) => b..directives.add(Directive.part('test.g.dart'))),
        equalsDart(r'''
            part 'test.g.dart';
          ''', DartEmitter()),
      );
    ...
    test('should emit a source file with part of directives', () {
      expect(
        Library((b) => b..directives.add(Directive.partOf('test.dart'))),
        equalsDart(r'''
            part of 'test.dart';
          ''', DartEmitter()),
      );
    ...
    test('should emit a source file with annotations', () {
      expect(
        Library(
          (b) => b
            ..name = 'js_interop'
            ..annotations.add(refer('JS', 'package:js/js.dart').call([])),
        ),
        equalsDart(r'''
          @JS()
          library js_interop;
    ...
    test('should emit an unnamed library source file with annotations', () {
      expect(
        Library(
          (b) => b..annotations.add(refer('JS', 'package:js/js.dart').call([])),
        ),
        equalsDart(r'''
          @JS()
          library;
    ...
    test('should emit an unnamed library source file with documentation', () {
      expect(
        Library((b) => b..docs.addAll(const ['/// My favorite library.'])),
        equalsDart(r'''
        /// My favorite library.
        library;
      '''),
      ...
      () {
        expect(
          Library(
            (b) => b
              ..annotations.add(
                refer('JS', 'dart:js_interop').call([literalString('vscode')]),
              )
              ..body.add(
                Method(
                  (m) => m
