...
class WindowsManuallyClosedDirectoryWatcher implements ManuallyClosedWatcher {
  @override
  final String path;
  ...
  /// parent directory to [path]. This is needed to detect changes to
  /// [path], as they are not included on Windows.
  ...
  /// On Windows, if [path] is deleted, we will not receive any event.
  ///
