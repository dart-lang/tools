...
void main() {
  ...
  for (final runInIsolate in [false, true]) {
    ...
    test(
      ...
      // Buffer exhaustion is very likely without the isolate and very unlikely
      // with it, but neither case is guaranteed.
      if (runInIsolate) {
        expect(totalErrorsSeen, lessThan(10));
      } else {
        expect(totalErrorsSeen, greaterThan(190));
      }
    });
  }
}
